  ...
  return (
    <main>
      <div className="container my-5">
        <h2 className='titulo-pagina mb-4'>TERMOS DE USO</h2>
        ...
        <div className="container my-3 py-1">
          ...
          <p>Staff: Responsáveis por gerenciar a ONG na plataforma. </p>
        </div>
        ...
        <div className="container my-3 py-1">
          ...
          <p>As ONGs devem analisar as doações e combinar a retirada diretamente com o doador. </p>
          <p>Qualquer comunicação entre usuários deve ser respeitosa e ética.</p>
        </div>
        ...
        <div className="container my-3 py-1">
          ...
          <p>O Doapego pode modificar estes Termos a qualquer momento. A continuidade do uso da plataforma após atualizações implica na aceitação das novas condições.</p>
        </div>

        <div className="container my-3 py-1">
          <h5>9. CONTATO</h5>
          <p>Para dúvidas ou suporte, entre em contato pelo e-mail <span className="fw-medium">doapegoitb@gmail.com</span>.</p>
        </div>
