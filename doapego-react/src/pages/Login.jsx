    ...
    <main className="container">
      ...
      <form onSubmit={handleLogin}>
        ...
        <div className="form-group">
          ...
          <input id='email-admin' type="text" placeholder="Insira seu e-mail cadastrado" value={emailAdmin} onChange={(e) => setEmailAdmin(e.target.value)} required />
        </div>

        <div className="form-group">
          <label htmlFor='senha-admin' className='form-label'>Senha</label>
          <input id='senha-admin' type="password" placeholder="Insira sua senha cadastrada" value={senha} onChange={(e) => setSenha(e.target.value)} required />
        </div>
