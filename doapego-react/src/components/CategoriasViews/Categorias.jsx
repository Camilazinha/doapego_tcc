                        ...
                        categorias.map((categoria, index) => (
                            <tr key={categoria.id}>
                                ...
                                <td className="text-center align-middle">
                                    {categoria.foto ? (
                                        <img src={categoria.foto} alt={`Foto de ${categoria.nome}`} width="70" height="70" style={{ objectFit: 'cover', borderRadius: '8px' }} />
                                    ) : ('Sem foto')}
                                </td>
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>Você tem certeza que deseja excluir a categoria <strong>{categorias.find(c => c.id === categoriaId)?.nome}</strong>?</p>
                            </div>
