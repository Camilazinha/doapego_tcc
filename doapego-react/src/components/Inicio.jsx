        ...
        return (
          <>
            <div className="col-12 col-md-6 col-lg-3 mb-3">
              <div id="cards-container2" className="card funcong-card">
                <div className="card-body">
                  <h5 className="card-title">Configurações</h5>
                  <p className="card-text">Gerencie e visualize suas informações.</p>
                  <a href="/configuracoes" className="btn btn-navbar-custom w-75">Ver configurações</a>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-3 mb-3">
              <div id="cards-container2" className="card funcong-card">
                <div className="card-body">
                  ...
                  <a href="/faq" className="btn ">Suporte</a>
                </div>
              </div>
            </div>
          </>
            ...
            <div className="col-12 col-md-6 col-lg-3 mb-3">
              <div id="cards-container2" className="card funcong-card">
                <div className="card-body">
                  ...
                  <a href="/gerenciar" className="btn btn-navbar-custom w-75">Acessar</a>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6 col-lg-3 mb-3">
              <div id="cards-container2" className="card funcong-card">
                <div className="card-body">
                  <h5 className="card-title">Ajuda</h5>
                  <p className="card-text">Encontre respostas para dúvidas frequentes ou entre em contato com o suporte.</p>
                  <a href="/gerenciar" className="btn btn-navbar-custom w-75">Suporte</a>
                </div>
              </div>
            </div>
          </>
            ...
            <div className="col-12 col-md-6 col-lg-3 mb-3">
              <div id="cards-container2" className="card funcong-card">
                <div className="card-body">
                  <h5 className="card-title">Ajuda</h5>
                  <p className="card-text">Encontre respostas para dúvidas frequentes ou entre em contato com o suporte.</p>
                  <a href="/faq" className="btn btn-navbar-custom w-75">Suporte</a>
                </div>
              </div>
            </div>
          </>
